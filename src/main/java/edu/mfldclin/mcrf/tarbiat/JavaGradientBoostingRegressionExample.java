...
public class JavaGradientBoostingRegressionExample {
  public static void main(String[] args) {
    ...
    // Save and load model
    // ahmad jan in vase ine ke chandin bar payapey beshe run kard bedune inke IO exception bede
    String runId = System.currentTimeMillis() + "";
    model.save(jsc.sc(), "target/tmp/" + runId + "/myGradientBoostingRegressionModel");
    GradientBoostedTreesModel sameModel = GradientBoostedTreesModel.load(jsc.sc(),
      "target/tmp/" + runId + "/myGradientBoostingRegressionModel");
    // $example off$
