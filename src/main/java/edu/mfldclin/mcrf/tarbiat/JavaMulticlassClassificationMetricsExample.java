...
public class JavaMulticlassClassificationMetricsExample {
  public static void main(String[] args) {
    ...
    // $example on$
    String path = Resource.getPath("data/mllib/sample_multiclass_classification_data.txt");
    ...
    String modelpath = "target/" + System.currentTimeMillis() + "/LogisticRegressionModel";
